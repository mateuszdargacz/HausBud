...
class Slide(models.Model):
    ...
    description_red = models.CharField(_("Text"), max_length=60, blank=True, null=True)
    description_black = models.CharField(_("Text"), max_length=60, blank=True, null=True)
    description_little = models.CharField(_("Text"), max_length=60, blank=True, null=True)
